################################################################################################################
#                                                                                                              #
# This code is taken from https://github.com/linkedin/Liger-Kernel/blob/main/examples/huggingface/callback.py  #
# It's functionality is to track the efficiency of the training process.                                       #
